  ...
  return (
    <View style={{marginTop:35}}>
      ...
      renderItem={({item, index})=>(
        <View style={{display:'flex', flexDirection:'row',alignItems:'center', gap:5, flex:1, borderRadius:10, borderWidth:1, margin:10, backgroundColor:'#fff', borderColor:Colors.PRIMARY}}>
